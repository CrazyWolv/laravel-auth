...
class ArtistSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        DB::table('artists')->insert([
            ...
            'image' => 'public/images/incubus.jpg',
        ...
        DB::table('artists')->insert([
            ...
            'image' => 'public/images/foo-fighters.jpg',
        ...
        DB::table('artists')->insert([
            ...
            'image' => 'public/images/igorrr.png',
        ...
        DB::table('artists')->insert([
            ...
            'image' => 'public/images/selah-sue.jpg',
            'url_video' => 'https://www.youtube.com/watch?v=Osqf4oIK0E8',
            'album' => 'Poisson Soluble
                Moisissure
                Poisson Soluble
        ...
        DB::table('artists')->insert([
            ...
            'name' => $faker->sentence(3, true),
            'description' => $faker->sentence(10, true),
            'image' => 'public/images/night-verses.jpg',
            'url_video' => 'https://www.youtube.com/watch?v=Osqf4oIK0E8',
            'album' => 'Poisson Soluble
                Moisissure
                Poisson Soluble
        ...
        DB::table('artists')->insert([
            ...
            'name' => $faker->sentence(3, true),
            'description' => $faker->sentence(10, true),
            'image' => 'public/images/artic-monkeys.jpg',
            'url_video' => 'https://www.youtube.com/watch?v=Osqf4oIK0E8',
            'album' => 'Poisson Soluble
                Moisissure
                Poisson Soluble
        ...
        DB::table('artists')->insert([
            ...
            'name' => $faker->sentence(3, true),
            'description' => $faker->sentence(10, true),
            'image' => 'public/images/white-stripes.jpg',
            'url_video' => 'https://www.youtube.com/watch?v=Osqf4oIK0E8',
            'album' => 'Poisson Soluble
                Moisissure
                Poisson Soluble
